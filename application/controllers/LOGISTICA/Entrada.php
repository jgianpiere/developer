...
class Entrada extends MY_Controller {
    ...
    */
    ...
    /**
    *   @todo       : Entrada Landing
    *   @author     : Gianpiere Ramos Bernuy. 
    */
    public function Entrada_Landing(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'):

            $this->load->model('COMPRASYGASTOS/m_Compras'); // Cargar Model de Compras 

            # RutaGuia
            $rutas =   array($this->rutapadre,array('title'=>'Logistica','route'=>site_url('Logistica#/Logistica/Entrada')));
            $RutaGuia = $this->htmltemplate->HTML_RutaGuia($rutas,'Entrada');
            ...
            $this->load->view('modules/LOGISTICA/view_Logistica_Entrada_landing.php');
    ...
    *   @author     : Gianpiere Ramos Bernuy. 
    */
    public function Entrada_Buscar(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'):
            $Campos = array(
            ...
            if($this->form_validation->run() == TRUE):
                ...
                $insert_result = $this->m_Logistica->Query_Buscar_CP_GuiaEntrada($Params);

                $html = $this->htmltemplate->HTML_EntradaInventario($insert_result);
    ...
    *   @author     : Gianpiere Ramos Bernuy. 
    */
    public function Entrada_Agregar(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'):
            $Campos = array(
            ...
            if($this->form_validation->run() == TRUE):
               ...
               $agre_modalidad_OrdenCompra          = $this->input->post('agre_modalidad_OrdenCompra'); 
                ...
                $insert_result = $this->m_Logistica->Query_Insertar_CP_GuiaEntrada($Params);
