            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade active in" id="tab_01">
                    ...
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12"> Buscar Adelanto </div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                    <form class="form-horizontal" id="form_buscar_adelanto" name="form_buscar_adelanto" style="padding:7px 7px 7px 7px;margin-top:30px;">
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-1 mtop-7">DNI :</label>
                                            <div class="col-lg-5 col-md-12 mtop-7">
                                                <input type="text" class="form-control" id="buscar_adelanto_DNI" name="buscar_adelanto_DNI" maxlength="8" placeholder="EJM: 46780390" validate="number">
                                            </div>

                                            <a id="buscaradelanto" class="btn btn-search control-label col-xs-1 mtop-7"></a>
                                        </div>
                ...
                <div class="tab-pane fade" id="tab_02">
                    ...
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12">Nuevo Adelanto</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                    <form class="form-horizontal" id="form_agregar_adelanto" name="form_agregar_adelanto" style="padding:7px 7px 7px 7px;margin-top:30px;">
                                        <input type="hidden" name="id" id="id" value="">
                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-1 mtop-7">DNI :</label>
                                            <div class="col-lg-5 col-md-12 mtop-7">
                                                <input type="text" class="form-control" id="adelanto_agreg_DNI" name="adelanto_agreg_DNI" maxlength="8" placeholder="EJM: 46780390" required validate="number">
                                            </div>

                                            <a searchinamexdni="#adelanto_agreg_DNI" data-for="#adelanto_agreg_Nombre" class="btn btn-search control-label col-xs-1 mtop-7"></a>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-2 col-md-1 mtop-7">Nombre :</label>
                                            <div class="col-lg-10 col-md-12 mtop-7">
                                                <input type="text" class="form-control" id="adelanto_agreg_Nombre" name="adelanto_agreg_Nombre" placeholder="" required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-md-3 col-xs-12 mtop-7">
                                                <input type="date" class="form-control" id="adelanto_fecha" name="adelanto_fecha" placeholder="" required datepicker>
                                            </div>

                                            <label class="control-label col-lg-2 col-sm-5 col-md-3 col-xs-12 mtop-7">Monto :</label>
                                            <div class="col-lg-4 col-sm-6 col-md-3 col-xs-12 mtop-7">
                                                <input type="text" class="form-control" id="adelanto_agreg_Monto" name="adelanto_agreg_Monto" placeholder="" required validate="float">
                                            </div> 
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-sm-6 col-md-3 col-xs-12 mtop-7">
                                                <textarea class="form-control" cols="50" rows="4" id="adelanto_agreg_observacion" name="adelanto_agreg_observacion" placeholder="Escribe aquí algunas observaciones"></textarea>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    (function(){
        ...
        // boton buscar lupa.
        $('#buscaradelanto').on('click',function(){
            $('form#form_buscar_adelanto').submit();
        });

        // submit buscar Adelanto
        $('form#form_buscar_adelanto').on('submit',function(e){ $$ = this; $this = $(this); $form = $this;
            e.preventDefault();
            if(1==1){
                $.ajax({
                    type        : 'POST',
                    data        : $form.serialize(),
                    url         : "<?=site_url('RecursosHumanos/Adelanto/Buscar')?>",
        ...
        // formulario Agregar Adelanto
        $('form#form_agregar_adelanto').on('submit',function(e){ $$ = this; $this = $(this); $form = $this;
            e.preventDefault();
            if(1==1){
                $.ajax({
                    type        : 'POST',
                    data        : $form.serialize(),
                    url         : "<?=site_url('RecursosHumanos/Adelanto/Agregar')?>",
                    success     : function(data){
                        try{
                            $data = $.parseJSON(data);
                            if($data[0] != 'ERROR' && $data[0] !='00'){
