                ...
                <div class="tab-pane fade active in" id="tab_02">
                    <div style="padding-top:15px;" >
                        <form class="form-horizontal" id="form_agreArea" name="form_agreArea">
                            <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom:30px;">Registro de Marca</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-9">
                                                <input type="text" class="form-control" id="agre_marca" name="agre_marca" placeholder="marca" required  validate="marca">
                                            </div>
                                        </div>
		...
		$('form#form_agreArea').on('submit',function(e){ $$ = this; $this = $(this); $form = $this; e.preventDefault();
            if(1==1){
                ...
                $.ajax({
                    type    : 'POST',
                    data    : $form.serialize(),
                    url     : "<?=site_url('/Administracion/rrhh/Marca/Agregar');?>",
