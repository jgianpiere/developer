                ...
                <div class="tab-pane fade active in" id="tab_01">
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12">Buscar Entrada - Inventario</div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <form class="form-horizontal" id="form_buscar_entrada" name="form_buscar_entrada" style="padding:7px 7px 7px 7px;margin-top:30px;">
...
var $descripcion;
    ...
    (function(){
        $('form#form_buscar_entrada').on('submit',function(e){ $$ = this; $this = $(this); $form = $this; e.preventDefault();
            if(1==1){
                $.ajax({
                    type    : 'POST',
                    data    : $form.serialize(),
