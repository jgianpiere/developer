            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="tab_01">
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12">Buscar Salida - Inventario</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                    <form class="form-horizontal" id="form_buscar_Salida" name="form_buscar_Salida" style="padding:7px 7px 7px 7px;margin-top:30px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-md-3 col-xs-12 mtop-7">
                                                <input type="date" value="<?=date('d-m-Y');?>" class="form-control" id="fecha_inicio" name="fecha_inicio" placeholder="" datepicker fechamin-to="#fecha_fin">
                                            </div>

                                            <label class="control-label col-lg-2 col-sm-5 col-md-3 col-xs-12 mtop-7">Fecha Fin :</label>
                                            <div class="col-lg-4 col-sm-6 col-md-3 col-xs-12 mtop-7">
                                                <input type="date" value="<?=date('d-m-Y');?>" class="form-control" id="fecha_fin" name="fecha_fin" placeholder="" datepicker>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-5 col-md-3 col-xs-10 mtop-7">
                                                <input type="text" class="form-control" id="num_cp" name="num_cp" placeholder="Documento">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="header" style="display:none;">
                                                <span style="background:red;color:white;border:1px solid white;padding:2px;" class="col-lg-4 col-md-12">N<s>°</s>. COMPROBANTE</span>
                                                <span style="background:red;color:white;border:1px solid white;padding:2px;" class="col-lg-2 col-md-12">FECHA</span>
                                                <span style="background:red;color:white;border:1px solid white;padding:2px;" class="col-lg-5 col-md-12">SUCURSAL</span>
                                                <span style="background:red;color:white;border:1px solid white;padding:2px;" class="col-lg-1 col-md-12">OPCIONES</span>
                                            </div>
                                            <div class="result">
                ...
                <div class="tab-pane fade" id="tab_02">
                    <div style="padding-top:15px;" >
                        <form class="form-horizontal" id="form_agregarOrdendeCompra" name="form_agregarOrdendeCompra">
                            <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom:30px;">Registro de Salida - Inventario</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                <input type="text" class="form-control" value="" id="agre_proveedor_OrdenCompra" name="agre_proveedor_OrdenCompra" placeholder="">
                                            </div>

                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <input type="text" class="form-control" value="" id="agre_codigo_proveedor_OrdenCompra" name="agre_codigo_proveedor_OrdenCompra" placeholder="">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-3 mtop-7">Direccion:</label>
                                            <div class="col-lg-9 mtop-7">
                                                <input type="text" placeholder="direccion" validate="alpha_numeric" name="agre_pro_direccionCasa" id="agre_pro_direccionCasa" class="form-control">
                                            </div>    
                                        </div>

                                        <div class="form-group">
                                            <input type="hidden" value="" id="responsableid" name="responsableid">
                                            <label class="control-label col-xs-3">Responsable :</label>
                                            <div class="col-xs-6">
                                                <input type="text" placeholder="" name="agre_persona_responsable" id="agre_persona_responsable" value="" class="form-control">
                                            </div>

                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <input type="text" placeholder="" name="agre_persona_responsable_dni" id="agre_persona_responsable_dni" value="" class="form-control">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-3 mtop-7">Motivo de Traslado:</label>
                                            <div class="col-lg-9 mtop-7">
                                                <input type="text" placeholder="" validate="alpha" name="agre_motivo_traslado" id="agre_motivo_traslado" class="form-control">
                                            </div>    
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-3 mtop-7">Marca Vehiculo:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="alpha_numeric" name="agre_marca_vehiculo" id="agre_marca_vehiculo" class="form-control">
                                            </div>

                                            <label class="control-label col-lg-3 mtop-7">Placa Vehiculo:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="alpha_numeric" name="agre_placa_vehiculo" id="agre_placa_vehiculo" class="form-control">
                                            </div>    
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-3 mtop-7">Conductor:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="alpha" name="agre_conductor" id="agre_conductor" class="form-control">
                                            </div>

                                            <label class="control-label col-lg-3 mtop-7">Licencia de conducir:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="alpha_numeric" name="agre_licencia" id="agre_licencia" class="form-control">
                                            </div>    
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-lg-3 mtop-7">Transportista:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="alpha" name="agre_transportistas" id="agre_transportistas" class="form-control">
                                            </div>

                                            <label class="control-label col-lg-3 mtop-7">RUC Transportista:</label>
                                            <div class="col-lg-3 mtop-7">
                                                <input type="text" placeholder="" validate="numeric" maxlength="10" name="agre_ruc_transportista" id="agre_ruc_transportista" class="form-control">
                                            </div>    
                                        </div>
...
var $descripcion;
    ...
    (function(){
        $('form#form_buscar_Salida').on('submit',function(e){ $$ = this; $this = $(this); $form = $this; e.preventDefault();
            if(1==1){
                $.ajax({
                    type    : 'POST',
                    data    : $form.serialize(),
                    url     : "<?=site_url('/Logistica/Logistica/Salida/Buscar');?>",
                    success : function(data){
                        try{
                            $data = $.parseJSON(data);
                            if($data[0] != 'ERROR' && $data[0] != '00'){
            ...
            if(1==1){
                ...
                if(parseFloat($total)>= 0){
                    ...
                    $.ajax({
                        ...
                        url     : "<?=site_url('/Logistica/Logistica/Salida/Agregar');?>",
                        success : function(data){
                            try{
                                $data = $.parseJSON(data);
    ...
    (function(){
        ...
        $(document).on('click','.delete_row',function(){ $$ = this; $this = $(this);
            if(confirm('Eliminar Orden de Compra ?')){
                $.ajax({
                    ...
                    url         : "<?=site_url('/Logistica/Logistica/Salida/Eliminar');?>",
                    success     : function(data){
                        try{
                            $data = $.parseJSON(data);
                            if($data[0]!='ERROR' && $data[0] != '00'){
        ...
        // Buscar Proveedor (Persona) por descripcion.
                            ...
                            if($data[0]!='ERROR'&&$data[0]!='00'){
                                ...
                                $this.autocomplete({
                                    ...
                                    select : function(event,ui){
                                        ...
                                        $('#agre_pro_direccionCasa').val($data[$codigo][3]);
        ...
        $('#agre_persona_responsable').on('keyup',function(e){ $$ = this; $this = $(this);
            $especiales = [8,9,35,36,37,38,39,40,46,13,32,186];
            if(jQuery.inArray(e.keyCode,$especiales) >= 0){
                return false;
            }
                        ...
                        try{
                            ...
                            if($data[0]!='ERROR'&&$data[0]!='00'){
                                ...
                                $this.autocomplete({
                                    ...
                                    select : function(event,ui){
                                        $codigo = jQuery.inArray(ui.item.label,$descripcion);
                                        $('#agre_persona_responsable_dni').val($data[$codigo][2]);
