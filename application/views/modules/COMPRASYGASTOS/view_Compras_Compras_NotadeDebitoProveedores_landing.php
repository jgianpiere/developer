            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="tab_01">
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12">Buscar Nota de Débito </div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                ...
                <div class="tab-pane fade" id="tab_02">
                    <div style="padding-top:15px;" >
                        <form class="form-horizontal" id="form_agregarOrdendeCompra" name="form_agregarOrdendeCompra">
                            <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom:30px;">Registro de Nota de Débito</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                <select typeDocSerie class="form-control" id="agre_documento_NotadeCredito" name="agre_documento_NotadeCredito" required>
                                            ...
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control text-uppercase" id="agre_serie_documento_NotadeCredito" name="agre_serie_documento_NotadeCredito" value="<?=isset($this->serie) ? $this->serie : '';?>" <?= isset($this->serie) && !empty($this->serie) ? 'readonly="true"' : ''; ?> placeholder="" required validate="alpha_numeric">
                                            </div>
                                            <label class="control-label col-separator"> - </label>
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control text-uppercase" id="agre_num_documento_NotadeCredito" name="agre_num_documento_NotadeCredito" value="<?=isset($this->numero) ? $this->numero : '';?>" <?= isset($this->numero) && !empty($this->numero) ? 'readonly="true"' : ''; ?> placeholder="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                <select class="form-control" id="agre_moneda_NotadeCredito" name="agre_moneda_NotadeCredito" required>
                                            ...
                                            <div class="col-xs-3">
                                                <select plan-selected=""  class="form-control" id="agre_plan_NotadeCredito" name="agre_plan_NotadeCredito" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-3">
                                                <input type="date" fechamax-to="#agre_fecha_entrega_NotadeCredito" class="form-control" id="agre_fecha_ingreso_NotadeCredito" name="agre_fecha_ingreso_NotadeCredito" placeholder="" data-fechamax="<?=date('d-m-Y');?>" required value="<?=date('d-m-Y');?>" datepicker>
                                            </div>

                                            <label class="control-label col-xs-3">Fecha de Emisión:</label>
                                            <div class="col-xs-3">
                                                <input type="date" class="form-control" data-fechamax="<?=date('d-m-Y');?>" value="<?=date('d-m-Y');?>" id="agre_fecha_entrega_NotadeCredito" name="agre_fecha_entrega_NotadeCredito" placeholder="" required datepicker>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <select class="form-control" required id="agre_almacen_NotadeCredito" name="agre_almacen_NotadeCredito"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <input type="text" class="form-control" value="" id="agre_proveedor_NotadeCredito" name="agre_proveedor_NotadeCredito" placeholder="Buscar por Nombre">
                                            </div>

                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <input type="text" class="form-control" value="" id="agre_codigo_proveedor_NotadeCredito" name="agre_codigo_proveedor_NotadeCredito" placeholder="Buscar Documento
">
                                ...
                                <div class="row">
                                    <div class="container-fluid">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-xs-2">
                                                <input type="text" class="form-control" id="agre_Total_NotadeCredito_total" name="agre_Total_NotadeCredito_total" placeholder="Total" required all-total validate="float" readonly="" value="0">
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="container-fluid">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-3 text-right">Crédito : <input type="checkbox" id="agre_credito_NotadeCredito" name="agre_credito_NotadeCredito" active-to="#agre_modalidad_NotadeCredito" value="0"></label>
                                            <!-- <div class="col-xs-2">
                                                <input type="number" class="form-control" id="agre_credito_NotadeCredito_dias" name="agre_credito_NotadeCredito_dias" placeholder="" required>
                                            </div>
                                            <label class="control-label col-xs-1 text-left">Días</label> -->

                                            <label class="control-label col-xs-2">Modalidad :</label>
                                            <div class="col-xs-3">
                                                <select class="form-control" required id="agre_modalidad_NotadeCredito" name="agre_modalidad_NotadeCredito" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                                <textarea name="agre_obs_NotadeCredito" id="agre_obs_NotadeCredito" cols="56" rows="3"></textarea>
                                            </div>
...
var $descripcion;
    ...
    function listar_productos($this){
        ...
        console.log(e.keyCode);
            ...
            var enviar = setInterval(function(){
                $.ajax({
                    type    : 'POST',
                    data    : 'value='+$$.val()+'&almacenid='+$('#agre_almacen_NotadeCredito').val(),
    ...
    (function(){
        ...
        $('form#form_agregarOrdendeCompra').on('submit',function(e){ $$ = this; $this = $(this); $form = $this; e.preventDefault();
            if(1==1){
                ...
                $total = parseFloat($('#agre_Total_NotadeCredito_total').val());
                ...
                $.ajax({
                    ...
                    success     : function(data){
                        try{
                            $data = $.parseJSON(data);
                            if($data[0] != 0){
                                $('#agre_serie_documento_NotadeCredito').val($data[1]).attr('readonly','true');
                                $('#agre_num_documento_NotadeCredito').val(('0000000'+String($data[2])).slice(-7)).attr('readonly','true');
                            }else{
                                $('#agre_serie_documento_NotadeCredito').val('').removeAttr('readonly');
                                $('#agre_num_documento_NotadeCredito').val('').removeAttr('readonly');
                            }
    ...
    (function(){
        ...
        $('#agre_proveedor_NotadeCredito').on('keyup',function(e){ $$ = this; $this = $(this);
            $especiales = [8,9,35,36,37,38,39,40,46,13,32,186];
            if(jQuery.inArray(e.keyCode,$especiales) >= 0){
                return false;
            }
                            ...
                            if($data[0]!='ERROR'&&$data[0]!='00'){
                                ...
                                $this.autocomplete({
                                    ...
                                    select : function(event,ui){
                                        ...
                                        $('#agre_codigo_proveedor_NotadeCredito').val($data[$codigo][2]);
        ...
        $('#agre_codigo_proveedor_NotadeCredito').on('keyup',function(e){ $$ = this; $this = $(this);
            $especiales = [8,9,35,36,37,38,39,40,46,13,32,186];
            if(jQuery.inArray(e.keyCode,$especiales) >= 0){
                return false;
            }
                        ...
                        try{
                            ...
                            if($data[0]!='ERROR'&&$data[0]!='00'){
                                ...
                                $this.autocomplete({
                                    ...
                                    select : function(event,ui){
                                        $codigo = jQuery.inArray(ui.item.label,$descripcion);
                                        $('#agre_proveedor_NotadeCredito').val($data[$codigo][1]);
                                        $('#proveedorid').val($data[$codigo][0]);
                                    }
                                });
                            }else{
