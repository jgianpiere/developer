        ...
        <?= isset($this->RutaGuia) && !empty($this->RutaGuia) ? $this->RutaGuia : '';?>
            ...
            <ul id="tab" class="nav nav-tabs">
                <li class="active"><a href="#tab_01" data-toggle="tab">Buscar Proveedor</a></li>
            </ul>
            <!-- tabs bar -->
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="tab_01">
                    <div style="padding-top:15px;" >
                        <div class="row tab-pane-title col-xs-12 col-sm-12 col-md-12 col-lg-12">Búsqueda de Proveedor</div>
                            <!-- Formulario -->
                            <div class="content">
                                <div class="row">
                                    <form class="form-horizontal" style="padding:7px 7px 7px 7px;margin-top:30px;" id="form_buscar_proveedores" name="form_buscar_proveedores">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-10 col-md-3 col-lg-2 mtop-7">
                                                <select class="form-control" id="proveedorBusPor" name="proveedorBusPor">
                                        ...
                                        <div class="row">
                                            <div style="display:none;" class="header">
                                                ...
                                                <span class="col-lg-4 col-md-12" style="background:red;color:white;border:1px solid white;padding:2px;">PROVEEDOR</span>
                                                <span class="col-lg-2 col-md-12" style="background:red;color:white;border:1px solid white;padding:2px;">TELEFONO</span>
                                                <span class="col-lg-3 col-md-12" style="background:red;color:white;border:1px solid white;padding:2px;">DIRECCIÓN</span>
                                                <span class="col-lg-1 col-md-12" style="background:red;color:white;border:1px solid white;padding:2px;">BORRAR</span>
                                            </div>
                                            <div class="result">
