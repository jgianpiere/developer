                                ...
                                <div class="row">
                                    <form class="form-horizontal" id="form_popup_newProveedor" name="form_popup_newProveedor" style="margin-top:30px;">
                                        ...
                                        <div class="form-group hidden-lg hidden-xs hidden-md hidden-sm">
                                            <label class="control-label col-lg-12 mtop-7 text-left" >Direc. Actual:</label>
                                            <label class="control-label col-lg-12 col-md-12 col-sm-12 col-xs-12 mtop-7" ><span class="label label-info col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:4px;text-align:left;">direccion</span></label>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4 col-md-1 mtop-7">Departamento:</label>
                                            <label class="control-label col-lg-4 col-md-1 mtop-7">Provincia :</label>
                                            <label class="control-label col-lg-4 col-md-1 mtop-7">Distrito :</label>
